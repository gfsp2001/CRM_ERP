...
export class CursoService {
  ...
  registro_curso_admin(data: any, token: any): Observable<any> {
    ...
    return this._http.post(this.url + 'registro_curso_admin', fd, { headers: headers });
  }
  ...
  actualizar_curso_admin(id: any, data: any, token: any): Observable<any> {
    if (data.banner != undefined) {
      ...
      fd.append('descripcion', data.descripcion);
      fd.append('banner', data.banner);
      return this._http.put(this.url + 'actualizar_curso_admin/' + id, fd, { headers: headers });

    } else {
      //creamos las cabeceras de autentificacion de esta peticion
      let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
      return this._http.put(this.url + 'actualizar_curso_admin/' + id, data, { headers: headers });
    }
  ...
  listar_curso_modal_admin(token: any): Observable<any> {
    //creamos las cabeceras de autentificacion de esta peticion
    let headers = new HttpHeaders({ 'Content-Type': 'application/json', 'Authorization': token });
    return this._http.get(this.url + 'listar_curso_modal_admin', { headers: headers });
  }
