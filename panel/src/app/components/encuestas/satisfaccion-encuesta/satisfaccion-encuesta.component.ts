...
export class SatisfaccionEncuestaComponent implements OnInit {
  ...
  enviar_encuesta() {
    if (!this.answer_one) {
      $.notify('Responda la pregunta uno.', {
        type: 'danger',
        spacing: 10,
        timer: 1000,
        placement: {
      ...
      $.notify('Responda la pregunta dos.', {
        type: 'danger',
        spacing: 10,
        timer: 1000,
        placement: {
      ...
      $.notify('Responda la pregunta tres.', {
        type: 'danger',
        spacing: 10,
        timer: 1000,
        placement: {
      ...
      $.notify('Responda la pregunta cuatro.', {
        type: 'danger',
        spacing: 10,
        timer: 1000,
        placement: {
      ...
      $.notify('Responda la pregunta cinco.', {
        type: 'danger',
        spacing: 10,
        timer: 1000,
        placement: {
      ...
      $.notify('Responda la pregunta seis.', {
        type: 'danger',
        spacing: 10,
        timer: 1000,
        placement: {
