...
export class PagoMatriculaComponent implements OnInit {
  ...
  init_pagos() {
    ...
    this._pagoService.obtener_matriculas_pagos_admin(this.id, this.token).subscribe(
      response => {
