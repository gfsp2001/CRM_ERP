...
app.get('/enviar_matriculas_hoy', auth.auth, matriculaController.enviar_matriculas_hoy);
app.get('/enviar_matriculas_fechas/:inicio/:hasta/:asesor', auth.auth, matriculaController.enviar_matriculas_fechas);
app.get('/send_invoice/:id', auth.auth, matriculaController.send_invoice);
app.get('/obtener_matriculas_admin/:id', auth.auth, matriculaController.obtener_matriculas_admin);
