...
app.post('/registro_curso_admin', [auth.auth, path], cursoController.registro_curso_admin);
...
app.put('/actualizar_curso_admin/:id', [auth.auth, path], cursoController.actualizar_curso_admin);
...
app.get('/listar_curso_modal_admin', auth.auth, cursoController.listar_curso_modal_admin);
